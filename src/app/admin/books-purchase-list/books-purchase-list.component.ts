...
@Component({
  selector: 'app-books-purchase-list',
  templateUrl: './books-purchase-list.component.html',
  styleUrls: ['./books-purchase-list.component.css']
})
export class BooksPurchaseListComponent implements OnInit {
  private message;
  private data  = [];
