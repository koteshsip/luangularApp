...
@Component({
  selector: 'app-add-books-purchase',
  templateUrl: './add-books-purchase.component.html',
  styleUrls: ['./add-books-purchase.component.css']
})
export class AddBooksPurchaseComponent implements OnInit {
  private data;
  form: FormGroup;
  private IsExist:any;
