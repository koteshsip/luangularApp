...
@Component({
  selector: 'app-add-books-issued',
  templateUrl: './add-books-issued.component.html',
  styleUrls: ['./add-books-issued.component.css']
})
export class AddBooksIssuedComponent implements OnInit {
  private data;
  form: FormGroup;
  private IsExist:any;
